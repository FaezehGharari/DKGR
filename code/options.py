...
def read_options():
    ...
    parser.add_argument("--data_input_dir", default="datasets/data_preprocessed/athleteplaysinleague/", type=str)
    parser.add_argument("--input_file", default="train.txt", type=str)
    parser.add_argument("--create_vocab", default=0, type=int)
    parser.add_argument("--vocab_dir", default="datasets/data_preprocessed/athleteplaysinleague/vocab", type=str)
    ...
    parser.add_argument("--base_output_dir", default='output/athleteplaysinleague/', type=str)
    parser.add_argument("--total_iterations", default=4, type=int)
    ...
    parser.add_argument("--use_cluster_embeddings", default=0, type=int)
    ...
    parser.add_argument("--model_load_dir", default="saved_models/athleteplaysinleague", type=str)
    parser.add_argument("--load_model", default=0, type=int)
    parser.add_argument("--nell_evaluation", default=1, type=int)
